...
if(isset($_POST['update'])){	
    ...
    if(empty($name) || empty($phone_number) || empty($gender) || empty($shipment_address) || empty($email) || empty($password) ) {	
        ...
        $result = mysqli_query($con, "UPDATE user SET name='$name',phone_number='$phone_number',gender='$gender',
                shipment_address='$shipment_address',email='$email',password='$password' WHERE u_id=$u_id");
