...
if(isset($_POST['update'])){	
    ...
    //Validation
    if( empty($phone_number) || empty($gender) || empty($shipment_address) || empty($password) ) {	
        ...
        $result = mysqli_query($con, "UPDATE user SET phone_number='$phone_number',gender='$gender',
